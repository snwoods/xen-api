...
module Observer = struct
  let create _ dbg uuid name_label attributes endpoints enabled =
    debug "Xenops Observer.create : dbg=%s" dbg ;
    Debug.with_thread_associated dbg
      (fun () ->
